...
global sentence_one
global segoesc_best_image_connect
segoesc_best_image_connect = ""
sentence_one = ""
...
class choose_level_segoesc(QDialog,form_choose_level):
    ...
    def choose_alphabet(self):
        ...
        type = "alphabet"
        self.close()
        make_font_image_alphabet_compare("segoesc")
        make_font_image_alphabet("segoesc")
        w = CWidget()
        w.show()
        w.exec_()
...
class choose_sentence(QDialog,form_choose_sentence):
    ...
    def famous_saying_text(self):
        ...
        make_font_image_compare("segoesc", get_text)
        make_font_image("segoesc", get_text)
        w = CWidget()
        w.show()
        w.exec_()
...
"font: 14pt \"-다정\";")
    ...
    def bb(self):
        ...
        i = 1
        if (type == "alphabet"):
            segoesc_best_image_connect = feedback_image_alphabet_connect
        elif (type == "sentence"):
            segoesc_best_image_connect = feedback_image_sentence_connect
    def backhome(self):
        self.close()
        from ui2 import MyWindow2
        w = MyWindow2()
    ...
    def __init__(self):
        ...
        def image_save():
            ...
            if (type == "alphabet"):
                while i < k:
                    # global type
                    feedback_image_alphabet = "segoesc_feedback_alphabet" + str(i) + ".png"

                    if os.path.isfile(feedback_image_alphabet):
                        i = i + 1
                    else:
                        type = "alphabet"
                        img.save("segoesc_feedback_alphabet" + str(i) + ".png")

                        feedback_image_alphabet_connect = "segoesc_feedback_alphabet" + str(i) + ".png"
                        break
            elif (type == "sentence"):
                while i < k:
                    # global type
                    feedback_image_sentence = "segoesc_feedback_sentence" + str(i) + ".png"

                    if os.path.isfile(feedback_image_sentence):
                        i = i + 1
                    else:
                        type = "sentence"
                        img.save("segoesc_feedback_sentence" + str(i) + ".png")
                        feedback_image_sentence_connect = "segoesc_feedback_sentence" + str(i) + ".png"
                        break
        gb = QGroupBox('')
        left.addWidget(gb)
