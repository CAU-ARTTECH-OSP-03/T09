...
global arial_best_image_connect
arial_best_image_connect = ""
global get_text
...
def make_font_image_alphabet_compare(font_name):
    ...
    draw.text(((860 - w1) / 2.0, 125), row1, font=ImageFont.truetype("C:/Windows/Fonts/" + font_name + ".ttf", 70),
              fill='black')
    draw.text(((860 - w2) / 2.0, 245), row2, font=ImageFont.truetype("C:/Windows/Fonts/" + font_name + ".ttf", 70),
              fill='black')
    draw.text(((860 - w3) / 2.0, 365), row3, font=ImageFont.truetype("C:/Windows/Fonts/" + font_name + ".ttf", 70),
              fill='black')
    draw.text(((860 - w4) / 2.0, 485), row4, font=ImageFont.truetype("C:/Windows/Fonts/" + font_name + ".ttf", 70),
              fill='black')
    while (True):
...
def make_font_image_alphabet(font_name):
    ...
    w4, h4 = draw.textsize(row4, font=myfont1)
    draw.text(((860 - w0) / 2.0, 50), font_name,
              font=ImageFont.truetype("C:/Windows/Fonts/" + font_name + ".ttf", 40),
              fill='black')
    draw.text(((860 - w1) / 2.0, 125), row1,
              font=ImageFont.truetype("C:/Windows/Fonts/" + font_name + ".ttf", 70),
              fill=(224,224,224))
    draw.text(((860 - w2) / 2.0, 245), row2,
              font=ImageFont.truetype("C:/Windows/Fonts/" + font_name + ".ttf" , 70),
              fill=(224,224,224))
    draw.text(((860 - w3) / 2.0, 365), row3,
              font=ImageFont.truetype("C:/Windows/Fonts/" + font_name + ".ttf" , 70),
              fill=(224,224,224))
    draw.text(((860 - w4) / 2.0, 485), row4,
              font=ImageFont.truetype("C:/Windows/Fonts/" + font_name + ".ttf", 70),
              fill=(224,224,224))
    while (True):
...
class choose_level_arial(QDialog,form_choose_level):
    ...
    def choose_alphabet(self):
        ...
        type = "alphabet"
        self.close()
        make_font_image_alphabet_compare("arial")
        make_font_image_alphabet("arial")
        w = CWidget()
        w.show()
        w.exec_()
...
class choose_sentence(QDialog,form_choose_sentence):
    ...
    def famous_saying_text(self):
        ...
        make_font_image_compare("arial", get_text)
        make_font_image("arial", get_text)
        w = CWidget()
        w.show()
        w.exec_()
...
"font: 14pt \"-다정\";")
    ...
    def bb(self):
        ...
        i = 1
        if (type == "alphabet"):
            arial_best_image_connect = feedback_image_alphabet_connect
        elif (type == "sentence"):
            arial_best_image_connect = feedback_image_sentence_connect
    def backhome(self):
        self.close()
        from ui2 import MyWindow2
        w = MyWindow2()
    ...
    def __init__(self):
        ...
        def image_save():
            ...
            if (type == "alphabet"):
                while i < k:
                    # global type
                    feedback_image_alphabet = "arial_feedback_alphabet" + str(i) + ".png"

                    if os.path.isfile(feedback_image_alphabet):
                        i = i + 1
                    else:
                        type = "alphabet"
                        img.save("arial_feedback_alphabet" + str(i) + ".png")

                        feedback_image_alphabet_connect = "arial_feedback_alphabet" + str(i) + ".png"
                        break
            elif (type == "sentence"):
                while i < k:
                    # global type
                    feedback_image_sentence = "arial_feedback_sentence" + str(i) + ".png"

                    if os.path.isfile(feedback_image_sentence):
                        i = i + 1
                    else:
                        type = "sentence"
                        img.save("arial_feedback_sentence" + str(i) + ".png")
                        feedback_image_sentence_connect = "arial_feedback_sentence" + str(i) + ".png"
                        break
